...
import os
# Windows user : pip install windows-curses 
...
if os.path.exists(".env"):
  ...
  print("export DEVELOPER_KEY=QIzaSyD9G993bcg2049OxR0d9KOZNkjo8AdkMJc")
  print("export CX=9e25cccedd0ad4433\n")
  print("Visit : https://console.developers.google.com for info\n")
